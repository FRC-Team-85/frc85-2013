...
public class Counter extends SensorBase implements CounterBase, LiveWindowSendable {
    ...
    public DigitalSource m_upSource;		///< What makes the counter count up.
    public DigitalSource m_downSource;	///< What makes the counter count down.
    public boolean m_allocatedUpSource;
    public boolean m_allocatedDownSource;
    public tCounter m_counter;				///< The FPGA counter object.
    public int m_index;					///< The index of this counter.
    public static Resource counters = new Resource(tCounter.kNumSystems);

    public void initCounter(final Mode mode) {
